from math import pi, cos, sqrt, arctan2
...
Returns a tuple of lists: latitude, longitude, velocity [km/h], 
...
See also: http://www.gpsinformation.org/dale/nmea.htm.
    ...
    return (list(latitude), list(longitude), \
        list(velocity), list(t_seconds), list(num_sats))
...
for root, dirs, files in os.walk('../data'):
    for filename in files:
        ...
        # generate an list of strings to be printed
